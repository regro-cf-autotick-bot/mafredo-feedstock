...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mafredo-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9289&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mafredo-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mafredo` can be installed with:

```
conda install mafredo
```

It is possible to list all of the versions of `mafredo` available on your platform with:
